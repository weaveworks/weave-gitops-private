...
promotion. Current pipelines in weave gitops does not support promotion. This RFC looks at different designs for notifying 
that a deployment has happened in order to trigger a promotion (if needed). 
