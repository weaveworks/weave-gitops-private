...
![wego install & add](images/wego-add-install.jpg "Add and Install")


_See original at [miro board][miro-orig] and the frame titled “WeGO Core phase 1 wep”_


#### Wego install {#wego-install}
...
1. create a git repo with the structure identified in Wego Directory Structure
...
*   The directory structure for the wego repo will be created as depicted in Wego Directory Structure
...
### Installing wego itself {#installing-wego-itself}
